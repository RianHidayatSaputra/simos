            ...
            <div class="card-body">
              ...
              <form action="{{route('ortu.update',$ortu->id)}}" method="POST">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="nama_ortu" id="nama_ortu" value="{{$ortu->nama_ortu}}" class="form-control">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Alamat</label>
                  <div class="col-sm-10">
                    <input type="text" name="alamat" value="{{$ortu->alamat}}" id="alamat" class="form-control">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputNumber" class="col-sm-2 col-form-label">No Telepon</label>
                  <div class="col-sm-10">
                    <input type="number" name="no_telp" value="{{$ortu->no_telp}}" id="no_telp" class="form-control">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputEmail" class="col-sm-2 col-form-label">username</label>
                  <div class="col-sm-10">
                    <input type="username" name="username" value="{{$ortu->username}}" id="username" class="form-control">
                  </div>
                </div>
                <div class="row mb-3">
