...
class RombelController extends Controller
{
    ...
    {
        RombelRepository::adddata($request);
    ...
    {
        $data['rombel'] = RombelsModel::findById($id);
        return view('rombel.edit', $data);
    }
    ...
    {
        RombelRepository::updatedata($request);
        return redirect('rombel');
    }
    ...
    {
        RombelRepository::deletedata($id);
        return redirect('rombel');
    }
}
